...
export default {
    ...
    props: {
        id: String,
        amountX: { type: Number, default: 50 },
        amountY: { type: Number, default: 50 },
    ...
    methods: {
        init() {
            ...
            container.style.top = `${this.top}vh`
            ...
            this.renderer.setSize(window.innerWidth, window.innerHeight * (1 - this.top / 100))
